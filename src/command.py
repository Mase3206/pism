...
def run(command: list[str], printOutput=False, logOutput=True, shell=False):
	"""
	Run the given command.
	"""

	with subprocess.Popen(command, stdout=subprocess.PIPE, stderr=subprocess.STDOUT, shell=shell) as process:
